...
var _menu = require("./javascript/menu");
var _modal = require("./javascript/modal"); // import './javascript/swiper';

},{"./javascript/menu":"59dfm","./javascript/modal":"8147a"}],"59dfm":[function(require,module,exports) {
(()=>{
    const refs = {
...
},{}],"8147a":[function(require,module,exports) {
(()=>{
    const refs = {
